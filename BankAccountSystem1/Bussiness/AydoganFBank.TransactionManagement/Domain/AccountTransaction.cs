...
namespace AydoganFBank.TransactionManagement.Domain
{
        ...
        IDomainEntity, ITransactionInfo
    {
        ...
        int ITransactionInfo.Id => TransactionId;
        ITransactionOwner ITransactionInfo.TransactionOwner => TransactionOwner;
        ITransactionOwner ITransactionInfo.FromTransactionOwner => FromTransactionOwner;
        ITransactionOwner ITransactionInfo.ToTransactionOwner => ToTransactionOwner;
        decimal ITransactionInfo.Amount => Amount;
        DateTime ITransactionInfo.TransactionDate => TransactionDate;
        ...
        void ITransactionInfo.SetStatus(TransactionStatusEnum transactionStatus)
        {
