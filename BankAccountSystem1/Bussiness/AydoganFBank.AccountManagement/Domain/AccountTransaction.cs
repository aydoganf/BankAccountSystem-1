        ...
        public TransactionDetailDomainEntity CreateTransactionDetail(TransactionDirection transactionDirection)
        {
            ...
            if (transactionDirection == TransactionDirection.In)
            {
                return coreContext.New<TransactionDetailDomainEntity>()
                    .With(description, TransactionDate, Amount, this, (ITransactionDetailOwner)ToTransactionOwner, transactionDirection, TransactionDate);
            }
            else
            {
                return coreContext.New<TransactionDetailDomainEntity>()
                    .With(description, TransactionDate, Amount, this, (ITransactionDetailOwner)FromTransactionOwner, transactionDirection, TransactionDate);
            }
        }
    }
